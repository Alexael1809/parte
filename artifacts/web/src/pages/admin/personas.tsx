    ...
    <Layout>
      <div className="p-6 max-w-5xl mx-auto">
        ...
        <div className="flex gap-3 mb-4">
          ...
          <select value={filterPeloton} onChange={(e) => setFilterPeloton(e.target.value)} className="bg-[#1B2B3D] border border-white/10 text-white rounded-lg px-3 py-2 text-sm focus:outline-none">
            ...
            <div key={p.id} className="bg-[#1B2B3D] border border-white/10 rounded-xl p-3 flex items-center justify-between gap-3">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-gray-500 text-xs">CI: {p.ci} · {p.pelotonNombre}</p>
                </div>
              </div>
